<form id="applicant-form">
	...
	<div class="section-block">
		...
		<div class="row item indent">
			<div class="col-xs-4">
				<input type="text" name = "first-name" readonly /><br>
				<p>First</p>
			</div>
			<div class="col-xs-4">
				<input type="text" name = "middle-name" readonly /><br>
				<p>Middle</p>
			</div>
			<div class="col-xs-4">
				<input type="text" name = "last-name" readonly /><br>
				<p>Last</p>
			</div>										
		</div>
		<div class="row item">
		...
		<div class="row item indent">
			<div class="col-xs-12">
				<input type="text" name = "address-two" readonly /><br>
				<p>Address Line 2</p>
			</div>									
		</div>
		<div class="row item indent">
			...
			<div class="col-xs-4">
				<input type="text" name = "zip" readonly /><br>
				<p>Zip / Postal Code</p>
			</div>													
		</div>
		<div class="row item">
		...
		<div class="row item indent">
			<div class="col-xs-3">
				<input type="text" name = "home-phone-1" class = "phone" readonly /> -
				<input type="text" name = "home-phone-2" class = "phone" readonly /> -
				<input type="text" name = "home-phone-3" class = "phone" readonly /><br>
				<p>Home</p>
			</div>
			<div class="col-xs-3">
				<input type="text" name = "cell-phone-1" class = "phone" readonly /> -
				<input type="text" name = "cell-phone-2" class = "phone" readonly /> -
				<input type="text" name = "cell-phone-3" class = "phone" readonly /><br>
				<p>Cell</p>
			</div>												
		</div>
		<div class="row item">
		...
		<div class="row item indent">
			...
			<div class="col-xs-3">
				<input type="text" name = "birthdate" placeholder = "MM/DD/YYYY" readonly /><br>
			</div>
			<div class="col-xs-3">
				<input type="text" name = "nationality" readonly /><br>
			</div>
			<div class="col-xs-3">
				<input type="text" name = "birthplace" readonly /><br>
			</div>															
		</div>											
		<div class="row item">
			<div class="col-xs-12">
		...
		<div class="row item indent">
			<div class="col-xs-4">
				<input type="text" name = "passport-number" readonly /><br>
				<p>Passport Number</p>
			</div>	
			<div class="col-xs-4">
				<input type="text" name = "passport-issue-date" readonly /><br>
				<p>Issue Date</p>
			</div>
			<div class="col-xs-4">
				<input type="text" name = "passport-expiration-date" readonly /><br>
				<p>Expiration Date</p>
			</div>															
		</div>
		<div class="row item">
		...
		<div class="row item indent">
			<div class="col-xs-12">
				<textarea name="gifts" readonly ></textarea>
			</div>													
		</div>
		<div class="row item">
			<div class="col-xs-12">
		...
		<div class="row item indent">
			<div class="col-xs-12">
				<textarea name="expectations" readonly ></textarea>
			</div>													
		</div>
		<div class="row item">
			<div class="col-xs-12">
		...
		<div class="row item indent">
			<div class="col-xs-12">
				<textarea name="concerns" readonly ></textarea>
			</div>													
		</div>	
		<div class="row item">
			<div class="col-xs-12">
		...
		<div class="row item indent">
			<div class="col-xs-12">
				<textarea name="health-issues" readonly ></textarea>
			</div>													
		</div>	
		<div class="row item">
			<div class="col-xs-12">
		...
		<div class="row item indent">
			<div class="col-xs-12">
				<textarea name="supportive" readonly ></textarea>
			</div>													
		</div>
	</div>
	...
	<div class = "section-block">
		...
		<div class="row item indent">
			<div class="col-xs-4">
				<input type="text" name = "reference1-name" readonly /><br>
				<p>Name</p>
			</div>	
			<div class="col-xs-4">
				<input type="text" name = "reference1-relationship" readonly /><br>
				<p>Relationship</p>
			</div>
			<div class="col-xs-4">
				<input type="text" name = "reference1-phone" readonly /><br>
				<p>Phone</p>
			</div>													
		</div>
		<div class="row item indent">
			<div class="col-xs-6">
				<input type="text" name = "reference1-email" readonly /><br>
				<p>Email</p>
			</div>													
		</div>
		<div class="row item">
	...
	<div class = "section-block">
		...
		<div class="row item indent">
			<div class="col-xs-12">
				...
				<p>
					<br>I, <input type="text" name = "legal-signature-first" placeholder = "Full legal name" id = "first-legal" readonly /> plan to participate in a short-term mission trip to Haiti and the planned activities and understand the actual itinerary and the actual activities that I participate in during the short-term mission trip may vary. I recognize the participation in the short-term mission trip and its activities may be hazardous and dangerous, and I willingly assume all risks associated with the short-term mission trip.<br><br>
